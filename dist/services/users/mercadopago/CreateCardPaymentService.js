...
class MercadoPagoService {
    static createCardPayment(paymentData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield (0, node_fetch_1.default)('https://api.mercadopago.com/v1/payments', {
                    method: 'POST',
                    headers: {
    ...
    static createSubscription(planId, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const plan = yield index_1.default.plan.findUnique({
                where: { id: planId },
            ...
            try {
                const response = yield (0, node_fetch_1.default)('https://api.mercadopago.com/preapproval', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'Authorization': `Bearer ${accessToken}`,
