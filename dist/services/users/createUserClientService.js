...
exports.CreateUserClientService = void 0;
...
class CreateUserClientService {
    execute({ name, email, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userClientAlreadyExists = yield prisma_1.default.userDesigner.findFirst({
                where: {
                    email: email
                }
            });
            ...
            const userClient = yield prisma_1.default.userClient.create({
                data: {
                    name: name,
                    email: email,
...
exports.CreateUserClientService = CreateUserClientService;
