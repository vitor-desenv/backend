...
interface PayLoad {
    ...
    role: 'USER' | 'MODERATOR' | 'ADMIN'  // Role do usuário
}

// Estendendo o Request para adicionar user_id e userRole
...
export function myAuthenticated(
    ...
    try {
        ...
        // Armazenar o ID e a role do token na requisição
        req.user_id = sub
        req.userRole = role
...
//>ANTES DE TENTAR CORRIGIR O ERRO DO MYCLIENT
// import { Request, Response, NextFunction } from 'express'
// import { verify } from 'jsonwebtoken'
